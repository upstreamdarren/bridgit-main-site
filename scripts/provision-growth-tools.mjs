...
async function ensureReportTool(secretId) {
  ...
  const toolConfig = {
    ...
    description: "Email a completed, consented Bridgit tool report to its user. Only call after you have summarised the plan, confirmed the email address and obtained explicit consent. Never include special-category personal data, safeguarding details or identifiable case information.",
    ...
    api_schema: {
      ...
      request_body_schema: { type: "object", property_kind: "object", required: ["name", "email", "toolkit_type", "context", "recommendation", "actions", "consent"], properties: {
        name: { type: "string", description: "Recipient's full name." }, email: { type: "string", description: "Recipient's confirmed email address." }, organisation: { type: ["string", "null"], description: "Organisation, or null." }, toolkit_type: { type: "string", enum: reportTypes, description: "Tool creating the report." }, context: { type: "string", description: "A concise non-sensitive summary of the context." }, recommendation: { type: "string", description: "The tailored recommendation or plan." }, actions: { type: "string", description: "Numbered practical next steps." }, considerations: { type: ["string", "null"], description: "Inclusion, safety, governance and delivery considerations." }, options: { type: ["string", "null"], description: "Options, partners, measures or resources to explore." }, consent: { type: "boolean", description: "True only after explicit consent to email." }
      } },
